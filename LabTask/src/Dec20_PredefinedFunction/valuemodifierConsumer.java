...
public class valuemodifierConsumer 
{
	public static void Valuemodifier(int number,Consumer<Integer>v1)
	{
		v1.accept(number);
	...
	public static void main(String[] args) 
	{
		...
		Consumer<Integer>doubleingv=number->System.out.println((number*2));
		Consumer<Integer>incrementing=number->System.out.println((number+3));
		Consumer<Integer>squareval=number->System.out.println((number*number));
		
		 Valuemodifier(numbersample,doubleingv);
		 Valuemodifier(numbersample,incrementing);
		 Valuemodifier(numbersample,squareval);
